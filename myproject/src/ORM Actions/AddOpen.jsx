...
function AddOpen() {
    ...
    <div className="heading">
      ...
      {showButtons && (
        <div className='bts'>
          ...
          <Button variant="primary" id='pri' onClick={handleShow}>+Add Actionable</Button>
        </div>
      )}
    </div>
  ...
  <Modal.Footer>
    ...
    <Button variant="primary" id="savebtn" onClick={() => { handleClose(); setAddTable(true); }}>
  Add
</Button>
  </Modal.Footer>
</Modal>
